...
//     version 1.14.2
//     from Assets/Inputs/JoystickInputs.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Inputs/JoystickInputs.inputactions".
/// </summary>
/// <remarks>
...
public partial class @JoystickInputs: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Cursor"",
            ""id"": ""d386c534-e915-44ed-849f-471acfeb280f"",
            ""actions"": [
                {
                    ""name"": ""MoveDelta"",
                    ""type"": ""PassThrough"",
                    ""id"": ""d7be2d9f-b6eb-4257-b713-791f2ec339a6"",
                ...
                },
                {
                    ""name"": ""Click"",
                    ""type"": ""Button"",
                    ""id"": ""e0c2b226-363c-4ef5-a30d-348f2f822a1d"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""61bcefbb-086a-450a-99cd-d71720180d09"",
                ...
                {
                    ""name"": """",
                    ""id"": ""5b4782e4-1036-4c12-a604-c6e57a5a2527"",
                ...
                {
                    ""name"": """",
                    ""id"": ""47ee850b-e821-4efb-98ac-3a625f4727b2"",
    ...
    ""controlSchemes"": []
        ...
        m_Cursor_MoveDelta = m_Cursor.FindAction("MoveDelta", throwIfNotFound: true);
        m_Cursor_Click = m_Cursor.FindAction("Click", throwIfNotFound: true);
    }

    ~@JoystickInputs()
    {
        UnityEngine.Debug.Assert(!m_Cursor.enabled, "This will cause a leak and performance issues, JoystickInputs.Cursor.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_Cursor_MoveDelta;
    ...
    public struct CursorActions
    {
        ...
        /// </summary>
        public CursorActions(@JoystickInputs wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Cursor/MoveDelta".
        /// </summary>
        public InputAction @MoveDelta => m_Wrapper.m_Cursor_MoveDelta;
        /// <summary>
